...
/**
 * DtoResponseError Class Doc Comment
 *
 * @category Class
 * @package  Zendit
 * @author   Zendit
 ...
 */
class DtoResponseError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dto.ResponseError';
