...
/**
 * DtoTopupPurchasesResponse Class Doc Comment
 *
 * @category Class
 * @package  Zendit
 * @author   Zendit
 ...
 */
class DtoTopupPurchasesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dto.TopupPurchasesResponse';
    ...
    protected static $openAPITypes = [
        'limit' => 'int',
        'list' => '\Zendit\Model\DtoTopupPurchase[]',
        'offset' => 'int',
        'total' => 'int'
    ];
