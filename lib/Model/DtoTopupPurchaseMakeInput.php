...
/**
 * DtoTopupPurchaseMakeInput Class Doc Comment
 *
 * @category Class
 * @package  Zendit
 * @author   Zendit
 ...
 */
class DtoTopupPurchaseMakeInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dto.TopupPurchaseMakeInput';
