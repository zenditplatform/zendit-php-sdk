...
/**
 * DtoESimOffer Class Doc Comment
 *
 * @category Class
 * @package  Zendit
 * @author   Zendit
 ...
 */
class DtoESimOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dto.ESimOffer';
